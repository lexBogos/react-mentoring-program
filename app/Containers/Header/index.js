...
const addMovieModalFields = (hook, list, setActive) => {
                    ...
                    <div>
                        <span>TITLE</span>
                        <input onChange={(event) => {movieObj.title = event.target.value}}></input>
                    </div>
                    <div>
                        <span>RELEASE DATE</span>
                        <input onChange={(event) => {movieObj.realiseDate = event.target.value}}></input>
                    </div>
                    <div>
                        <span>MOVIE URL</span>
                        <input onChange={(event) => {movieObj.movieUrl = event.target.value}}></input>
                    </div>
                    <div>
                        <span>GENRE</span>
...
const Header = ({setModalActive, setModalFields }) => {
    return (<div className='headerContainer'>
            <div className="headerImage"></div>
            <h1 className='title'>Find your movie</h1>
            <AddMovie setModalFields={setModalFields} func={addMovieModalFields} setModalActive={setModalActive}/>
